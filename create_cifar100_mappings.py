"""
Create correct index-based pseudo-label mappings for CIFAR-100.
...
def create_mappings(
    paths_file="results/dinov2_large_cifar100_with_paths/image_paths.json",
    pseudo_labels_dir="results/cifar100_pseudolabels/pseudo_labels",
    predictions_file="results/cifar100_pseudolabels/predictions.npz"
):
    """Create path-based pseudo-label mappings"""
    
    print("="*80)
    print("CREATING CORRECT PATH-BASED PSEUDO-LABEL MAPPING FOR CIFAR-100")
    print("="*80)
...
pseudo_label = mapping['train/0/000002.png']  # For training image

# Or use CSV
import pandas as pd
df = pd.read_csv('train_image_pseudo_labels.csv')
pseudo_label = df[df['image_path'] == 'train/0/000002.png']['pseudo_label_class_index'].values[0]
""")
